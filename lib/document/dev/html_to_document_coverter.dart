...
String html = '''
<div class="container">
<h1 style="color: #474c52 !important;" class="text-muted">When does Celebrated use customer information from third parties?</h1>
<p class="text-muted">We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a Celebrated customer, we receive information from a third party that provides automated fraud detection services to Celebrated. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.</p>
<br>
...
<p class="text-muted">Celebrated will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>
<br>
...
<p class="text-muted">The rights you have to request updates or corrections to the information Celebrated collects depend on your relationship with Celebrated. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
...
<p class="text-muted">We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of Celebrated or any of its Corporate Affiliates (as defined herein), or that portion of Celebrated or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>
<br>
<h1 style="color: #474c52 !important;" class="text-muted">Affiliates</h1>
<p class="text-muted">We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, "Corporate Affiliate" means any person or entity which directly or indirectly controls, is controlled by or is under common control with Celebrated, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>
<br>
<h1 style="color: #474c52 !important;" class="text-muted">Governing Law</h1>
<p class="text-muted">This Privacy Policy is governed by the laws of Canada without regard to its conflict of laws provision. You consent to the exclusive jurisdiction of the courts in connection with any action or dispute arising between the parties under or in connection with this Privacy Policy except for those individuals who may have rights to make claims under Privacy Shield, or the Swiss-US framework.</p>
<p class="text-muted">The laws of Canada, excluding its conflicts of law rules, shall govern this Agreement and your use of the website/app. Your use of the website/app may also be subject to other local, state, national, or international laws.</p>
<p class="text-muted">By using Celebrated or contacting us directly, you signify your acceptance of this Privacy Policy. If you do not agree to this Privacy Policy, you should not engage with our website, or use our services. Continued use of the website, direct engagement with us, or following the posting of changes to this Privacy Policy that do not significantly affect the use or disclosure of your personal information will mean that you accept those changes.</p>
<br>
<h1 style="color: #474c52 !important;" class="text-muted">Your Consent</h1>
<p class="text-muted">We've updated our&nbsp;Privacy Policy&nbsp;to provide you with complete transparency into what is being set when you visit our site and how it's being used. By using our Celebrated, registering an account, or making a purchase, you hereby consent to our Privacy Policy and agree to its terms.</p>
<br>
<h1 style="color: #474c52 !important;" class="text-muted">Links to Other Websites</h1>
<p class="text-muted">This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by Celebrated. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website’s own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.</p>
<br>
<h1 style="color: #474c52 !important;" class="text-muted">Advertising</h1>
<p class="text-muted">This website/app may contain third party advertisements and links to third party sites. Celebrated does not make any representation as to the accuracy or suitability of any of the information contained in those advertisements or sites and does not accept any responsibility or liability for the conduct or content of those advertisements and sites and the offerings made by the third parties.</p>
<p class="text-muted">Advertising keeps Celebrated and many of the websites and services you use free of charge. We work hard to make sure that ads are safe, unobtrusive, and as relevant as possible.</p>
<p class="text-muted">Third party advertisements and links to other sites where goods or services are advertised are not endorsements or recommendations by Celebrated of the third party sites, goods or services. Celebrated takes no responsibility for the content of any of the ads, promises made, or the quality/reliability of the products or services offered in all advertisements.</p>
<br>
<h1 style="color: #474c52 !important;" class="text-muted">Cookies for Advertising</h1>
<p class="text-muted">These cookies collect information over time about your online activity on the website/app and other online services to make online advertisements more relevant and effective to you. This is known as interest-based advertising. They also perform functions like preventing the same ad from continuously reappearing and ensuring that ads are properly displayed for advertisers. Without cookies, it’s really hard for an advertiser to reach its audience, or to know how many ads were shown and how many clicks they received.</p>
<br>
<h1 style="color: #474c52 !important;" class="text-muted">Cookies</h1>
<p class="text-muted">Celebrated uses "Cookies" to identify the areas of our website that you have visited. A Cookie is a small piece of data stored on your computer or mobile device by your web browser. We use Cookies to enhance the performance and functionality of our website/app but are non-essential to their use. However, without these cookies, certain functionality like videos may become unavailable or you would be required to enter your login details every time you visit the website/app as we would not be able to remember that you had logged in previously. Most web browsers can be set to disable the use of Cookies. However, if you disable Cookies, you may not be able to access functionality on our website correctly or at all. We never place Personally Identifiable Information in Cookies.</p>
<br>
...
<p class="text-muted">You acknowledge and agree that Celebrated shall not be responsible for any Third-Party Services, including their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other aspect thereof. Celebrated does not assume and shall not have any liability or responsibility to you or any other person or entity for any Third-Party Services.</p>
...
<br><br>
<p class="text-muted">We use Cookies to enhance the performance and functionality of our <!--?=platform;?--> but are non-essential to their use. However, without these cookies, certain functionality like videos may become unavailable or you would be required to enter your login details every time you visit the 
as we would not be able to remember that you had logged in previously.</p>
...
<p class="text-muted">GDPR adds some new requirements regarding how companies should protect individuals' personal data that they collect and process. It also raises the stakes for compliance by increasing enforcement and imposing greater fines for breach. Beyond these facts it's simply the right thing to do. At Celebrated we strongly believe that your data privacy is very important and we already have solid security and privacy practices in place that go beyond the requirements of this new regulation.</p>
<br>
...
<ul class="text-muted">
<li>Via Email:  rodrick.vy@gmail.com</li>
<li>Via Phone Number:  778-239-3874</li>                 
 </ul>
</div>
</div>
</div>
...
void getHeadingElements(String html){
  RegExp(r'\<(\w+).*\>(.+)\<').allMatches(html).toList().forEach((e){
    // print(e[1]);
    switch(e[1]){
      case 'h1':
        print(" DocElement(DocElType.title,'''${(e[2]!).replaceAll("\n", '')}'''),");
        break;
      case 'p':
        print(" DocElement(DocElType.paragraph,'''${(e[2]!).replaceAll("\n", '')}'''),");
        break;
      case 'li':
        print(" DocElement(DocElType.bulletPoint,'''${(e[2]!).replaceAll("\n", '')}'''),");
        break;
    }
  });
  // Iterable<String?> headings =  RegExp(r'\<h1 .+\>(.+)\<\/h1>').allMatches(html).toList().map((m)=>m[1]);
  // Iterable<String?> paragraphs =  RegExp(r'\<p1 .+\>(.+)\<\/p1>').allMatches(html).toList().map((m)=>m[1]);
  //
  //   headings.forEach((element) {
  //     print(" DocElement(DocElType.title,'''$element'''),");
  //   });
}


void main(){
  getHeadingElements(html);
}