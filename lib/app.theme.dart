...
class AppTheme {
  static ThemeData themeData = ThemeData(
    //accentColor: AppSwatch.primary.shade500
      ...
      textTheme: TextTheme(
        ...
        subtitle1:
            GoogleFonts.playfairDisplay(fontSize: 15, fontWeight: FontWeight.w400, color: Colors.black, letterSpacing: 0.15),
        subtitle2:
            GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w500, color: Colors.black, letterSpacing: 0.1),
        bodyText1: GoogleFonts.inter(fontSize: 17, fontWeight: FontWeight.w400, color: Colors.black, letterSpacing: 0.5),
        bodyText2:
            GoogleFonts.lato(fontSize: 15, fontWeight: FontWeight.w400, color: Colors.black, letterSpacing: 0.25),
        button: GoogleFonts.lato(fontSize: 15, fontWeight: FontWeight.w500, color: Colors.black, letterSpacing: 1.25),
  ...
  static LinearGradient  lightGradient = LinearGradient(colors: [AppSwatch.primary.shade400,AppSwatch.primaryAccent.shade700],begin: Alignment.topCenter,end: Alignment.bottomRight);
